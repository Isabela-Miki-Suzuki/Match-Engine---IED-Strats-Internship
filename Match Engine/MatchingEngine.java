    ...
    public static void main(String[] args){
        ...
        while (scanner.hasNextLine()) {
            ...
            if (s[0].equals("limit")) {
                ...
                book.removeTheIdentifiedOrderFromTheBook(s[2]);
            }
            // input example: >>> edit order identificator_1 to 100 @ 10
                ...
                if (book.orderCorrespondingToIdentifier.containsKey(identifier) && 
                    book.orderCorrespondingToIdentifier.get(identifier).getQuantity() > 0) {
                    LimitOrder limitOrder = book.orderCorrespondingToIdentifier.get(identifier);
                    book.removeTheIdentifiedOrderFromTheBook(identifier);
